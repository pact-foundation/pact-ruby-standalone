...
This version (2.4.3) of the Pact standalone executables package contains:

  * pact gem 1.64.0
  * pact-mock_service gem 3.11.2
  * pact-support gem 1.20.0
  * pact-provider-verifier gem 1.38.0
  * pact_broker-client gem 1.75.2
...
Ruby is not required on the host platform, Ruby 3.3.1 is provided in the distributable.

| OS     | Ruby      | Architecture   | Supported |
| -------| -------   | ------------   | --------- |
| MacOS  | 3.3.1     | x86_64         | ✅        |
| MacOS  | 3.3.1     | aarch64 (arm64)| ✅        |
| Linux  | 3.3.1     | x86_64         | ✅        |
| Linux  | 3.3.1     | aarch64 (arm64)| ✅        |
| Windows| 3.3.1     | x86_64         | ✅        |
| Windows| 3.3.1     | x86            | ✅        |
| Windows| 3.3.1     | aarch64 (arm64)| 🚧        |
